    ...
    <div className="px-6 max-w-[1000px] mx-auto md:my-12" id="contact">
      <Reveal>
        <div className="grid md:grid-cols-2 place-items-center">
          <div>
            <div className="text-gray-300 my-3">
              ...
              <p className="text-justify leading-7 w-11/12 mx-auto">
                ...
                "A dynamic and eager fresher with proven leadership and organizational abilities, coupled with a knack for effective multitasking. I aim to contribute to the growth of a forward-thinking organization while honing my skills and expanding my expertise to align with its mission and objectives."
              </p>
            </div>
          ...
          <form
            action="https://formsubmit.co/9f711d8a860b53a22706a4d1eb3c5f21"
            method="POST"
